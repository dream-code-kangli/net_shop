...
class AliPay(object):
    ...
    def sign_data(self, data):
        ...
        # 添加上‘’
        quoted_string = "&".join("{0}={1}".format(k, v) for k, v in unsigned_items)
...
if __name__ == '__main__':
    ali = AliPay(appid=2021000118665738, app_notify_url='http://1270.0.1:8000/order/checkPay/',
                 app_private_key_path='order_app/keys/my_private_key.txt',
                 alipay_public_key_path='order_app/keys/my_public_key.txt',
                 return_url='http://1270.0.1:8000/order/checkPay/', debug=False)
    print('https://openapi.alipaydev.com/gateway.do?' + ali.direct_pay(subject='asdsad', total_amount='0.01',
                                                                       out_trade_no='1000000000000000'))
