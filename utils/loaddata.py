...
from net_shop_app.models import *
        ...
        for data in datas:
            ...
            for goods in _goods:
                ...
                for _color in goods['colors']:
                    color = Color.objects.create(colorname=_color[0], color=_color[1])
                    colors.append(color)
                ...
                for _spec in goods['specs']:
                    ...
                    for img in _spec[1]:
                        GoodsDetail.objects.create(goods=good, detail=goodsdetails, gdurl=img)
